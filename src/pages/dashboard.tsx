...
import { useLocationCount, useBookingCount, useCarLocationCount } from 'lib/roq';
...
function DashboardPage() {
  ...
  const carLocationStat = useCarLocationCount();
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    ...
    {
      title: 'Car Locations',
      result: carLocationStat?.data,
      isLoading: carLocationStat.isLoading,
      change: Math.floor(Math.random() * (100 - 40 + 1) + 40),
    },
