...
export function CarListPage(props: CarListPageProps) {
  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: [, 'booking.count', 'car_location.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('booking', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('car_location', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'car_location',
          header: 'Car Location',
          accessorKey: 'car_location',
          cell: ({ row: { original: record } }: any) => record?._count?.car_location,
        }
      : null,
