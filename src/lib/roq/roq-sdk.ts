...
import type { Prisma, booking, car, car_location, company, location, user } from './types';
...
interface Car_locationSDK {
  create: <
    T extends Prisma.car_locationCreateArgs,
    R extends CheckSelect<T, car_location, Prisma.car_locationGetPayload<T>>,
  >(
    data: Prisma.SelectSubset<T, Prisma.car_locationCreateArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  createMany: <T extends Prisma.car_locationCreateManyArgs, R extends Prisma.BatchPayload>(
    args: Prisma.SelectSubset<T, Prisma.car_locationCreateManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  update: <T extends Prisma.car_locationUpdateArgs, R extends Prisma.car_locationGetPayload<T>>(
    data: Prisma.SelectSubset<T, Prisma.car_locationUpdateArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  updateMany: <T extends Prisma.car_locationUpdateManyArgs, R extends Prisma.BatchPayload>(
    args: Prisma.SelectSubset<T, Prisma.car_locationUpdateManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  upsert: <T extends Prisma.car_locationUpsertArgs, R extends Prisma.car_locationGetPayload<T>>(
    data: Prisma.SelectSubset<T, Prisma.car_locationUpsertArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  delete: <T extends Prisma.car_locationDeleteArgs, R extends Prisma.car_locationGetPayload<T>>(
    data: Prisma.SelectSubset<T, Prisma.car_locationDeleteArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  deleteMany: <T extends Prisma.car_locationDeleteManyArgs, R extends Prisma.BatchPayload>(
    args: Prisma.SelectSubset<T, Prisma.car_locationDeleteManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;
  ...
  count: <T extends Prisma.car_locationCountArgs, R extends number>(
...
export class RoqClient {
  ...
  public car_location: Car_locationSDK;
  ...
  private initSDK() {
    ...
    this.car_location = {
      create: async function createCar_location<
        T extends Prisma.car_locationCreateArgs,
        R extends CheckSelect<T, car_location, Prisma.car_locationGetPayload<T>>,
      >(data: Prisma.SelectSubset<T, Prisma.car_locationCreateArgs>, options?: RequestOptions) {
        const response = await fetcher<R, true>(
          `${ctx.endpoint}/api/model/car_location/create`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'POST',
      ...
      createMany: async function createManyCar_location<
        T extends Prisma.car_locationCreateManyArgs,
        R extends Prisma.BatchPayload,
      >(data: Prisma.SelectSubset<T, Prisma.car_locationCreateManyArgs>, options?: RequestOptions) {
        const response = await fetcher<R, false>(
          `${ctx.endpoint}/api/model/car_location/createMany`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'POST',
      ...
      update: async function updateCar_location<
        T extends Prisma.car_locationUpdateArgs,
        R extends Prisma.car_locationGetPayload<T>,
      >(data: Prisma.SelectSubset<T, Prisma.car_locationUpdateArgs>, options?: RequestOptions) {
        const response = await fetcher<R, true>(
          `${ctx.endpoint}/api/model/car_location/update`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'PUT',
      ...
      updateMany: async function updateManyCar_location<
        T extends Prisma.car_locationUpdateManyArgs,
        R extends Prisma.BatchPayload,
      >(data: Prisma.SelectSubset<T, Prisma.car_locationUpdateManyArgs>, options?: RequestOptions) {
        const response = await fetcher<R, false>(
          `${ctx.endpoint}/api/model/car_location/updateMany`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'PUT',
      ...
      upsert: async function upsertCar_location<
        T extends Prisma.car_locationUpsertArgs,
        R extends Prisma.car_locationGetPayload<T>,
      >(data: Prisma.SelectSubset<T, Prisma.car_locationUpsertArgs>, options?: RequestOptions) {
        const response = await fetcher<R, true>(
          `${ctx.endpoint}/api/model/car_location/upsert`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'POST',
      ...
      delete: async function deleteCar_location<
        T extends Prisma.car_locationDeleteArgs,
        R extends Prisma.car_locationGetPayload<T>,
      >(data: Prisma.SelectSubset<T, Prisma.car_locationDeleteArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/car_location/delete`;
        const reqUrl = makeUrl(url, data);
        const response = await fetcher<R, true>(
          reqUrl,
          {
      ...
      deleteMany: async function deleteManyCar_location<
        T extends Prisma.car_locationDeleteManyArgs,
        R extends Prisma.BatchPayload,
      >(data: Prisma.SelectSubset<T, Prisma.car_locationDeleteManyArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/car_location/deleteMany`;
        const reqUrl = makeUrl(url, data);
        const response = await fetcher<R, false>(
          reqUrl,
          {
      ...
      findMany: async function findManyCar_location<
        T extends Prisma.car_locationFindManyArgs,
        R extends GetFindResult<Prisma.$car_locationPayload<DefaultArgs>, T>[],
      >(args: Prisma.SelectSubset<T, Prisma.car_locationFindManyArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/car_location/findMany`;
        const urlWithArgs = makeUrl(url, args);
        const response = await fetcher<R, false>(
          urlWithArgs,
          {
      ...
      count: async function countCar_location<T extends Prisma.car_locationCountArgs, R extends number>(
        args: Prisma.SelectSubset<T, Prisma.car_locationCountArgs>,
        options?: RequestOptions,
      ) {
        const url = `${ctx.endpoint}/api/model/car_location/count`;
        const urlWithArgs = makeUrl(url, args);
        const response = await fetcher<R, false>(
          urlWithArgs,
          {
      ...
      findManyWithCount: async function findManyWithCountCar_location<
        T extends Prisma.car_locationFindManyArgs,
        R extends GetFindResult<Prisma.$car_locationPayload<DefaultArgs>, T>[],
        C extends number,
      >(args: Prisma.SelectSubset<T, Prisma.car_locationFindManyArgs>, options?: RequestOptions) {
        const { distinct, orderBy, where } = args || {};
        const [data, count] = await Promise.all([
          ctx.car_location.findMany(args, options),
          ctx.car_location.count(
            {
              distinct,
              orderBy,
              where,
      ...
      findFirst: async function findFirstCar_location<
        T extends Prisma.car_locationFindFirstArgs,
        R extends GetFindResult<Prisma.$car_locationPayload<DefaultArgs>, T>,
      >(args?: Prisma.SelectSubset<T, Prisma.car_locationFindFirstArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/car_location/findFirst`;
        const urlWithArgs = makeUrl(url, args);
        const response = await fetcher<R, false>(
          urlWithArgs,
          {
